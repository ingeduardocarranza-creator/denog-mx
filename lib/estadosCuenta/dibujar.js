...
export const C_CIELO = {
  ...
  marcaClaro: '#bdecff',
  beigeLinea: '#dcebf5',
  marcaTexto: '#eaf6fd',   // texto secundario sobre el azul medio
...
export const MARCOS = {
  ...
  // Cielo: crema arriba y abajo, marino en el total. Hace juego con el ticket.
  cielo: {
    fondo: ['#f9eae5'], filete: '#466d9b',
    titulo: '#263c55', sub: '#466d9b', texto: '#3f5a76', linea: '#e3d3cc',
    facebook: null, instagram: null, tiktok: '#263c55', web: '#466d9b',
