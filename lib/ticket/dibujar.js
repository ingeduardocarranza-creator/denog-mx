...
export async function dibujarTicket(datos, entorno) {
  ...
  const seccion = (titulo, filas, y0) => {
    ...
    filas.forEach((f, i) => {
      ...
      // El nombre del producto va en el tono más oscuro: es la línea que el
      // cliente de verdad lee para comprobar que se llevó lo que pidió.
      izq(recortar(etiqueta, 12, W - PAD * 2 - 110 * S), PAD, y + rowH / 2, 12, P.tinta)
