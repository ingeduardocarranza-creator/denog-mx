...
Responde SOLO con JSON válido, sin texto adicional, con esta forma exacta:
{
  ...
  "moneda": "MXN" o "USD" — MXN si el ticket es de una tienda/gasolinera en México (texto
    en español, "$" junto a IVA), USD si es de EE.UU. (tienda gringa, "sales tax", texto en
    inglés). Si no se puede saber, usa "MXN".
