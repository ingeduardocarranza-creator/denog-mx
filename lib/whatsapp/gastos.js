...
{
  "monto": número (el total del ticket, en pesos mexicanos si el ticket es de México o
    dólares si es de EE.UU. — usa el número tal como aparece, sin convertir) o null si no
    se alcanza a leer,
  ...
  "descripcion": "una línea breve, ej. \\"Gasolina - Circle K\\" o \\"Cena con proveedor\\"" (máx 60 caracteres)
    ...
    return { monto: null, categoria: 'Otro', descripcion: null }
  }
}
