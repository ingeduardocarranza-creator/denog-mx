...
// Una foto y el texto que la acompaña salen con segundos de diferencia. Más
// que eso ya no es la pareja de nadie.
const VENTANA_ADELANTO_MS = 120_000
  ...
  try {
    ...
    for (let i = 0; i < lista.length; i++) {
      ...
      if (abierta && !abierta.cliente_id && abierta.precio_usd == null) {
        ...
        // siguiente mensaje de ESTA MISMA fila es una foto que llegó con
        // segundos de diferencia — si sí, es la suya, y se arma adelantada.
